...
use crate::components::ui::icons::{CircleIcon, MapPinIcon};
    ...
    rsx! {
        section { id: "top", class: "px-4 pb-12 pt-14 md:pt-20",
            ...
            p { class: "mt-5 max-w-xl text-pretty leading-relaxed text-muted-foreground md:text-lg",
                "A full-stack engineer who builds fast, accessible products for the web. \
                 I obsess over developer experience, clean systems, and interfaces that \
                 feel a little bit like the future. Currently designing tools that make \
                 other developers faster."
            }
            ...
            div { class: "mt-5 flex flex-wrap items-center gap-4 font-mono text-xs text-muted-foreground",
                ...
                span { class: "inline-flex items-center gap-1.5",
                    ...
                    "TypeScript \u{b7} Rust \u{b7} Next.js"
                }
            }
